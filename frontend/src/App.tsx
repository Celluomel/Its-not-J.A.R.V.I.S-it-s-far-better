...
type HomeAssistantDiscovery = { ok?: boolean; status?: string; count?: number; message?: string; entities?: { entity_id: string; state?: string; friendly_name?: string; unit?: string | null }[] };
