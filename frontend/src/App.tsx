...
import { Activity, ArrowDown, ArrowLeft, ArrowUp, AudioLines, Check, ChevronRight, Copy, Database, Expand, Eye, History, Lightbulb, MessageCircle, Mic, MicOff, Network, PanelRightOpen, Pause, Phone, Play, RefreshCw, Rss, Search, Send, Settings, Sparkles, Square, ThumbsDown, ThumbsUp, Volume2, Wifi, Workflow, X } from 'lucide-react';
...
type SettingsTab = 'llm' | 'memory' | 'voice' | 'vision' | 'status' | 'lumina' | 'tools' | 'analytics' | 'development';
const settingTabs: { id: SettingsTab; label: string; icon: ReactNode }[] = [
  ...
  { id: 'voice', label: 'Voice', icon: <AudioLines size={16}/> }, { id: 'vision', label: 'Vision', icon: <Eye size={16}/> },
...
const settingsFields: Record<Exclude<SettingsTab, 'status' | 'lumina' | 'tools' | 'analytics' | 'development'>, { key: string; label: string; type?: 'select' | 'number' | 'textarea' | 'checkbox'; options?: string[] }[]> = {
