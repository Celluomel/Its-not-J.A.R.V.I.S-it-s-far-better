...
class GoalActionExecutor:
    ...
    def _action_user_question(self, goal) -> Dict:
        """
        Queue a focused question to ask the user, grounded in what Lumina
        has actually been thinking about (not generic templates).

        The question is generated by LLM using the goal topic + any recent
        insight Lumina formed about it — so the user question naturally
    ...
    async def _action_web_search(self, goal) -> None:
        ...
        results through the prism of Lumina's current emotional state and beliefs.
        ...
        on Lumina's epistemic state — that's what makes it cognitively real.
        """
        try:
    ...
    async def _interpret_through_identity(
        ...
        This is the moment personality becomes CAUSAL — not "Lumina is curious"
