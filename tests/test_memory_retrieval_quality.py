...
class MemoryRetrievalQualityTests(unittest.TestCase):
    DOCUMENTS = [
        "The Arduino Q development board was considered for Lumina's future physical body and embodiment, with a movable camera and LiDAR.",
        ...
        "Flux and Lumina exchange messages through the network dialogue session.",
    ...
    CASES = [
        ("Which development board was considered for Lumina's physical embodiment?", 0),
        ...
        ("How do Flux and Lumina exchange messages?", 5),
